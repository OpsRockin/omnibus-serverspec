...
bundle exec kitchen exec ${TARGET} -c "export PATH=${RUBYPATH}:\$PATH; export HOME=/home/vagrant ; export BUILD_ITERATION=${BUILD_ITERATION}; cd /home/vagrant/serverspec; ./bin/omnibus build serverspec"
